...
def main():
    ...
    ssl_encoder = ssl_models.build_ssl_encoder(
        args.method, proj_dim=args.proj_dim,
        depth=args.depth, base_filters=args.base_filters, activation=args.activation)
    ...
    meta = {
        ...
        "depth": args.depth, "base_filters": args.base_filters,
